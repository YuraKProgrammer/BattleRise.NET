...
{
    [Fighter("Орк", FighterType.Orc, FighterPower.Unusual)]
    public class Orc : FighterBase, IFighter, IHasPosition
    {
        ...
        public const string fileFolder = @"/BattleRise.DesktopClient;component/images/8.jpg";
        public const string fileFolderEnemy = @"/BattleRise.DesktopClient;component/images/8.2.jpg";
        public const Element element = Element.Earth;

        private ElementDamageController damageController = new ElementDamageController();

        public Orc(int level, int x, int y, Side side)
        {
            this.x = x;
            this.y = y;
            name = "Орк";
