...
{
    [Fighter("Зомби", FighterType.Zombie, FighterPower.Unusual)]
    public class Zombie : FighterBase, IFighter, IHasPosition
    {
        ...
        public const string fileFolder = @"/BattleRise.DesktopClient;component/images/3.jpg";
        public const string fileFolderEnemy = @"/BattleRise.DesktopClient;component/images/3.2.jpg";
