...
{
    [Fighter("Маг", FighterType.Magician, FighterPower.Rare)]
    public class Magician : FighterBase, IFighter, IHasPosition
    {
        ...
        public const string fileFolder = @"/BattleRise.DesktopClient;component/images/10.jpg";
        public const string fileFolderEnemy = @"/BattleRise.DesktopClient;component/images/10.2.jpg";
        public const Element element = Element.Fire;

        private ElementDamageController damageController = new ElementDamageController();

        public Magician(int level, int x, int y, Side side)
        {
            this.x = x;
            this.y = y;
            name = "Маг";
