...
namespace BattleRise.Models.Fighters
{
    public class Warrior : FighterBase, IFighter, IHasPosition
    {
        ...
        public const string fileFolder = @"/BattleRise.DesktopClient;component/images/1.jpg";
        public const string fileFolderEnemy = @"/BattleRise.DesktopClient;component/images/1.2.jpg";
