...
{
    [Fighter("Лучник", FighterType.Archer, FighterPower.Ordinary)]
    public class Archer : FighterBase, IFighter , IHasPosition
    {
        ...
        public const string fileFolder = @"/BattleRise.DesktopClient;component/images/2.jpg";
        public const string fileFolderEnemy = @"/BattleRise.DesktopClient;component/images/2.2.jpg";
