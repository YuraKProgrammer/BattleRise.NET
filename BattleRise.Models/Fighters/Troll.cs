...
namespace BattleRise.Models.Fighters
{
    public class Troll : IFighter
    {
        ...
        public const string fileFolder = @"/BattleRise.DesktopClient;component/images/9.jpg";
        public const string fileFolderEnemy = @"/BattleRise.DesktopClient;component/images/9.2.jpg";
        public const Element element = Element.Earth;

        private ElementDamageController damageController = new ElementDamageController();

        public Troll(int level, int x, int y, Side side)
        {
            this.x = x;
            this.y = y;
            name = "Тролль";
